...
function onKeyDownChangeBackgroundColorForward() {
	...
	if(currentBackgroundColorIndex == backgroudColorList.length - 1) {
		currentBackgroundColorIndex = 0;
		console.log(currentBackgroundColorIndex);
	} else {
...
function onKeyDownChangeBackgroundColorBackwards() {
	...
	if(currentBackgroundColorIndex == 0) {
		currentBackgroundColorIndex = backgroudColorList.length - 1;
		console.log(currentBackgroundColorIndex);
	} else {
		currentBackgroundColorIndex--;
		console.log(currentBackgroundColorIndex);
